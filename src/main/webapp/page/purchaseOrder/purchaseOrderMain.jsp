...
<section class="content">
    <div class="row">
        ...
        <form:form commandName="purchaseOrder"  id="mainForm"  action="" method="post" >
            <form:hidden path="purchaseOrderID" id="mainId"></form:hidden>
        </form:form>
        ...
        <div class="col-md-3">
            ...
            <a href="javascript:$('#manageModal .modal-body').load('<c:url value="/main/purchaseOrder/manage"/>',function(e){$('#manageModal').modal('show');});"
            ...
            <div class="box box-solid">
                ...
                <div class="box-body" style="display: block;">
                    <div class="form-group">
                        <label >purchaseCode</label>
                        <input id="input_criteria_0" class="form-control" placeholder="Enter purchaseCode" >
                    </div>
                    <div class="form-group">
                        <label >purchaseDate</label>
                        <input id="input_criteria_1" class="form-control" placeholder="Enter purchaseDate" >
                    </div>
                            ...
                            <table id="mainDataTable" class="table table-bordered table-hover dataTable" role="grid" >
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" >purchaseDate</th>
                                ...
                                <c:if test="${not empty purchaseOrderList}">
                                    <c:forEach var="listObject" items="${purchaseOrderList}">
                                        <tr role="row" class="odd">
                                            <td>${listObject.purchaseCode}</td>
                                            <td style="text-align: center;"><fmt:formatDate value="${listObject.purchaseDate}" type="both" pattern="dd/MM/yyyy" /></td>
                                            ...
                                            <td align="center">
                                                <button type="submit" class="btn btn-success btn-xs" data-toggle="tooltip" title="" data-original-title="add"
                                                        onclick="javascript:$('#manageModal .modal-body').load('<c:url value="/main/purchaseOrder/manage/?id=${listObject.purchaseOrderID}&action=add"/>',function(e){$('#manageModal').modal('show');});" >
                                                    <i class="fa fa-plus"></i>
                                                </button>
                                                <button type="submit" class="btn btn-warning btn-xs" data-toggle="tooltip" title="" data-original-title="edit"
                                                        onclick="javascript:$('#manageModal .modal-body').load('<c:url value="/main/purchaseOrder/manage/?id=${listObject.purchaseOrderID}"/>',function(e){$('#manageModal').modal('show');});" >
                                                    <i class="fa fa-edit"></i>
                                                </button>
                                                <button type="submit" class="btn btn-danger btn-xs"  data-toggle="tooltip" title="" data-original-title="delete" onclick="manageDelete(${listObject.purchaseOrderID},'purchaseOrder');"> <i class="fa fa-trash"></i></button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:if>
