...
<form:form commandName="catagory"  id="manageForm" role="form" class="form-horizontal" action="catagory/save" method="post" >
    <form:hidden path="catagoryID" ></form:hidden>

    <div class="form-group">
        <label for="catagoryName" class="control-label col-md-3">Name:</label>
        <div class="col-md-9">
            <form:input type="text" class="form-control" path="catagoryName" id="catagoryName"  placeholder="Enter Code" ></form:input>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="modal-footer modal-footer-modify">
        ...
        <c:set var="manageId" value="${catagory.catagoryID}" />
        <c:if test="${manageId gt 0}">
            <button type="button" class="btn btn-danger " onclick="manageDelete(${manageId},'catagory');" >ยกเลิก</button>
        </c:if>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#manageForm').formValidation({
            ...
            fields: {
                catagoryName: {
                    message: 'The catagoryName is not valid',
                    validators: {
                        notEmpty: {
                            message: 'The catagoryName is required'
                        },
                        stringLength: {
                            max: 100,
                            message: 'The catagoryName must  less than 100 characters long'
                        }
                    }
                },
                description: {
                ...
                parentId: {
                    message: 'The parentId is not valid',
                    stringLength: {
                        max: 10,
                        message: 'The parentId must  less than 10 characters long'
                    }
                },
                active: {
