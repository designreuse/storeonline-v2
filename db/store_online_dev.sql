...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 15, 2015 at 07:20 PM
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='InnoDB free: 8192 kB; (`GEO_ID`) REFER `crewphra/geography`(' AUTO_INCREMENT=999 ;

--
-- Dumping data for table `amphurs`
--

INSERT INTO `amphurs` (`AMPHUR_ID`, `AMPHUR_CODE`, `AMPHUR_NAME`, `GEO_ID`, `PROVINCE_ID`) VALUES
...
INSERT INTO `brand` (`brandID`, `active`, `brandName`, `description`, `picture`) VALUES
(1, 'yes', 'sony', 'test', NULL),
(2, 'yes', 'asus', 'test', NULL),
(3, 'yes', 'apple', 'test', NULL);
...
INSERT INTO `catagory` (`catagoryID`, `active`, `catagoryName`, `description`) VALUES
(1, 'yes', 'เหล็ก', 'เหล็ก'),
(2, 'yes', 'กระจก', ''),
(3, 'yes', 'อลูมิเนียม', ''),
(4, 'yes', 'หลังคา', '');
...
INSERT INTO `commondata` (`id`, `code`, `seq`, `enabled`, `value`, `name`) VALUES
(1, 'TITLE_NAME', 1, 'yes', '1', 'นาย'),
(2, 'TITLE_NAME', 2, 'yes', '2', 'นาง'),
(3, 'VAT', 1, 'yes', '7.00', 'ภาษีมูลค้าเพิ่ม'),
(4, 'SEX', 1, 'yes', 'F', 'หญิง'),
(5, 'SEX', 1, 'yes', 'M', 'ชาย');
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `businessRegistrationId` varchar(255) DEFAULT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='InnoDB free: 8192 kB' AUTO_INCREMENT=8861 ;
...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  `layerLevel` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `menu` (`id`, `action`, `active`, `description`, `images`, `layerLevel`, `name`, `parentId`, `seq`) VALUES
(1, '#', 'yes', NULL, NULL, 'main', 'เมนูหลัก', NULL, '1'),
(2, '#', 'yes', '', '', 'main', 'เมนูระบบ', '', '2'),
(3, '/main/user/main', 'yes', 'จัดการข้อมูลผู้ใช้งาน', 'fa-user', 'sub1', 'เมนูผู้ใช้งาน', '2', '1'),
(4, '/main/menu/main', 'yes', 'จัดการข้อมูลเมนูระบบ', 'fa-th', 'sub1', 'ข้อมูลเมนู', '2', '3'),
(5, '#', 'yes', '', 'fa-user', 'sub1', 'ลูกค้า', '1', '1'),
(6, '#', 'yes', '', 'fa-home', 'sub1', 'คลังสินค้า', '1', '2'),
(7, '#', 'yes', '', 'fa-archive', 'sub1', 'สินค้า', '1', '3'),
(8, '#', 'no', '', 'fa-book', 'sub1', 'ใบสั่งสินค้า', '1', '4'),
(9, '#', 'yes', '', 'fa-book', 'sub1', 'ใบเบิกสินค้า', '1', '5'),
(10, '#', 'no', '', 'fa-book', 'sub1', 'ใบส่งซ่อม/ส่งเครมสินค้า', '1', '6'),
(11, '/main/warehouse/main', 'yes', 'จัดการข้อมูลคลัง', 'fa-home', 'sub2', 'ข้อมูลคลัง', '6', '1'),
(12, '/main/product/main', 'yes', '', 'fa-archive', 'sub2', 'ข้อมูลสินค้า', '7', '1'),
(13, '/main/roleUser/main', 'no', 'ข้อมูลหน่วยงาน', 'fa-users', 'sub1', 'ข้อมูลหน่วยงาน', '2', '2'),
(14, '/main/unit/main', 'yes', 'หน่วยนับ', 'fa-cubes', 'sub2', 'หน่วยนับ', '7', '2'),
(15, '/main/catagory/main', 'yes', 'หมวดหมู่สินค้า', 'fa-cube', 'sub2', 'หมวดหมู่สินค้า', '7', '3'),
(16, '/main/brand/main', 'yes', 'ยี่หอ', 'fa-tag', 'sub2', 'ยี่หอ', '7', '4'),
(17, '/main/supplier/main', 'yes', 'ข้อมูลผู้ผลิต', 'fa-truck', 'sub2', 'ข้อมูลผู้ผลิต', '20', '1'),
(18, '/main/commonData/main', 'yes', 'ข้อมูลตัวแปร', 'fa-gear', 'sub1', 'ข้อมูลตัวแปร', '2', '3'),
(19, '/main/warehouse/product/main', 'yes', 'จัดการสินค้าเข้าคลัง', 'fa-cubes', 'sub2', 'จัดการสินค้า', '6', '2'),
(20, '#', 'yes', '', 'fa-truck', 'sub1', 'ผู้ผลิต', '1', '1'),
(21, '#', 'yes', '', 'fa-book', 'sub1', 'ใบรับสินค้า', '1', '4'),
(22, '/main/purchaseOrder/main', 'yes', '', 'fa-file-text-o', 'sub2', 'ข้อมูลใบสั่งสินค้า', '8', '10'),
(23, '/main/purchaseOrder/main', 'yes', '', 'fa-file-text-o', 'sub2', 'ข้อมูลใบเบิกสินค้า', '9', '10'),
(24, '/main/recieptOrder/main', 'yes', '', 'fa-file-text-o', 'sub2', 'ข้อมูลใบรับสินค้า', '21', '10');
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `description` varchar(255) DEFAULT NULL,
  `picture` longblob,
  `pointOfOrder` int(11) NOT NULL,
  `productCode` varchar(255) DEFAULT NULL,
  `productName` varchar(255) DEFAULT NULL,
  `unitCost` decimal(19,2) DEFAULT NULL,
  ...
  KEY `FK_ergi2uoi8h38jikomkqe5343q` (`brandID`),
  KEY `FK_kyh5g9n7oum9dfwt5eaf8b2b1` (`catagoryID`),
  KEY `FK_ftjs049l02amiawgxkdyn3mct` (`unitID`)
...
INSERT INTO `product` (`productID`, `active`, `description`, `picture`, `pointOfOrder`, `productCode`, `productName`, `unitCost`, `unitPrice`, `unitsInStock`, `unitsOnOrder`, `brandID`, `catagoryID`, `unitID`) VALUES
(4, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1234567890, 'SP0000004', 'เหล็กเส้น 20 นิ้ว', '20000.00', '10.20', 1234567890, 1234567890, 2, 1, 3),
(5, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1234567890, 'SP0000001', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1234567890, 1234567890, 2, 1, 3),
(6, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1234567890, 'SP0000002', 'เหล็กเส้น 20 นิ้ว', '20000.00', '10.20', 1234567890, 1234567890, 2, 1, 3),
(7, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1234567890, 'SP0000003', 'เหล็กเส้น 30 นิ้ว', '20000.00', '10.20', 1234567890, 1234567890, 2, 1, 3),
(8, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 3000, 'SP0000005', 'เหล็กเส้น 50 นิ้ว', '10000.00', '20000.00', 1000, 2000, 2, 1, 3),
(10, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(11, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(12, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(13, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(14, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(15, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(16, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(17, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(18, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(19, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(20, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(21, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(22, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(23, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3),
(24, 'yes', 'เหล็กเส้น 10 นิ้ว ก่อสร้าง', NULL, 1000, 'SP0000006', 'เหล็กเส้น 10 นิ้ว', '20000.00', '10.20', 1000, 1000000, 2, 1, 3);
...
CREATE TABLE IF NOT EXISTS `purchaseorder` (
  ...
  KEY `FK_povsc206v27p0awpd0en0xmg7` (`supplierID`)
...
INSERT INTO `purchaseorder` (`purchaseOrderID`, `purchaseCode`, `purchaseDate`, `referenceNumber`, `remark`, `requiredDate`, `vat`, `supplierID`) VALUES
(1, 'PR-000001', '2015-07-02 00:00:00', 'testset', 'testset', '2015-07-24 00:00:00', 7, 1),
(2, 'PR-000004', '2015-07-02 00:00:00', '10.00', 'testset', '2015-07-24 00:00:00', 8, 2),
(3, 'PR-000002', '2015-07-02 00:00:00', 'testset', 'testset', '2015-07-24 00:00:00', 8, 2),
(16, 'PR-000003', '2015-07-02 00:00:00', '10.00', 'testset', '2015-07-24 00:00:00', 8, 2),
(17, 'PR-000005', '2015-07-02 00:00:00', '10.00', 'testset', '2015-07-24 00:00:00', 8, 2),
(18, 'PR-000006', '2015-07-02 00:00:00', '10.00', 'testset', '2015-07-24 00:00:00', 8, 2),
(22, 'PR-000007', '2015-07-02 00:00:00', '10.00', 'testset', '2015-07-24 00:00:00', 8, 2);
...
CREATE TABLE IF NOT EXISTS `purchaseorderproduct` (
  `purchaseOrderProductID` int(11) NOT NULL AUTO_INCREMENT,
  `amount` int(11) NOT NULL,
  `price` decimal(19,2) DEFAULT NULL,
  `purchaseOrderID` int(11) NOT NULL,
  `productID` int(11) DEFAULT NULL,
  PRIMARY KEY (`purchaseOrderProductID`),
  KEY `FK_oy5h77qvmksegi5v8sk43e716` (`productID`)
...
INSERT INTO `purchaseorderproduct` (`purchaseOrderProductID`, `amount`, `price`, `purchaseOrderID`, `productID`) VALUES
(21, 1000, '1500.00', 1, 5),
(22, 1200, '100.00', 1, 12),
(25, 1000, '1000.00', 22, 5),
(26, 2000, '3000.00', 22, 6);

-- --------------------------------------------------------

--
-- Table structure for table `recieptorder`
--

CREATE TABLE IF NOT EXISTS `recieptorder` (
  `recieptOrderID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `supplierID` int(11) DEFAULT NULL,
  `vat` double DEFAULT NULL,
  PRIMARY KEY (`recieptOrderID`),
  KEY `FK_2a0skl2r1l015jsty7qglw39w` (`supplierID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13 ;

--
-- Dumping data for table `recieptorder`
--

INSERT INTO `recieptorder` (`recieptOrderID`, `recieptCode`, `recieptDate`, `referenceNumber`, `remark`, `supplierID`, `vat`) VALUES
(9, 'RC-0000004', '2015-08-06 00:00:00', '543543', '12543543', 1, 7),
(10, 'RC-0000001', '2015-08-06 00:00:00', '543543', '12543543', 1, 7),
(11, 'RC-0000002', '2015-08-06 00:00:00', '543543', '12543543', 3, 7),
(12, 'RC-0000003', '2015-08-06 00:00:00', '543543', '12543543', 2, 7);

-- --------------------------------------------------------

--
-- Table structure for table `recieptorderproduct`
--

CREATE TABLE IF NOT EXISTS `recieptorderproduct` (
  `recieptOrderProductID` int(11) NOT NULL AUTO_INCREMENT,
  `amount` int(11) NOT NULL,
  `price` decimal(19,2) DEFAULT NULL,
  `recieptOrderID` int(11) NOT NULL,
  `productID` int(11) DEFAULT NULL,
  PRIMARY KEY (`recieptOrderProductID`),
  KEY `FK_aghi9709oqfrvb6pvbrw674qp` (`productID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=39 ;

--
-- Dumping data for table `recieptorderproduct`
--

INSERT INTO `recieptorderproduct` (`recieptOrderProductID`, `amount`, `price`, `recieptOrderID`, `productID`) VALUES
(24, 1000, '200.00', 9, 5),
(25, 100, '200.00', 9, 6),
(26, 2000, '10.00', 9, 8),
(27, 1000, '200.00', 10, 5),
...
CREATE TABLE IF NOT EXISTS `supplier` (
  ...
  `email` varchar(255) DEFAULT NULL,
  `fax` varchar(255) DEFAULT NULL,
  `phomeMobile` varchar(255) DEFAULT NULL,
...
INSERT INTO `supplier` (`supplierID`, `address`, `companyName`, `contractName`, `email`, `fax`, `phomeMobile`, `phoneOffice`, `zipcode`, `amphurID`, `districtID`, `provinceID`) VALUES
(1, '103/63', 'บริษัท yeamgood', 'นายธนรัฐ นิยมตรง', 'yeamgood@gmail.com', '123456789', '0878336750', '0878336750', '24110', 179, 1442, 15),
(2, '103/63', 'บริษัท ตาแดง', 'นายธนรัฐ นิยมตรง', 'yeamgood@gmail.com', '123456789', '0878336750', '0878336750', '10200', 1, 6, 1),
(3, '103/63', 'บริษัท yeamgood 2', 'นายธนรัฐ นิยมตรง', 'yeamgood@gmail.com', '123456789', '0878336750', '0878336750', '10200', 1, 1, 1);
...
--
-- Table structure for table `system_user_test`
--

CREATE TABLE IF NOT EXISTS `system_user_test` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `enabled` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `system_user_test`
--

INSERT INTO `system_user_test` (`id`, `email`, `enabled`, `name`, `password`, `user_role`) VALUES
...
INSERT INTO `unit` (`unitID`, `active`, `unitCode`, `unitName`) VALUES
(1, 'yes', '''', 'บาน'),
(2, 'yes', 'STK', 'ท่อน'),
(3, 'yes', '''', 'เส้น'),
(4, 'yes', '''', 'โหล');
...
INSERT INTO `user` (`id`, `email`, `enabled`, `password`, `user_role`, `username`, `name`) VALUES
(14, 'test@hotmail.com', 'yes', '1234', 'ROLE_ADMIN', 'yeamgood', 'YeamGood'),
(22, 'test@hotmail.com', 'no', '1234', 'ROLE_ADMIN', 'yeamgood1', '1234'),
(23, 'test@hotmail.com', 'yes', 'test', 'ROLE_ADMIN', 'testtest', 'test'),
(30, 'test@hotmail.com', 'yes', 'test', 'ROLE_ADMIN', 'testtest2', 'test');
...
INSERT INTO `warehouse` (`warehouseID`, `address`, `dealer`, `description`, `telephone`, `warehouseName`, `active`) VALUES
(1, '11/1 ต.หน้าเมือง อ.เมือง จ.ฉะเชิงเทรา 24000', 'นายธนรัฐ นิยมตรง', 'คลังกรุงเทพ', '089-999999', 'คลังกรุงเทพ', 'yes'),
(3, '11/1 ต.หน้าเมือง อ.เมือง จ.ฉะเชิงเทรา 24000', 'นายธนรัฐ นิยมตรง', 'คลังฉะเชิงเทรา', '089-999999', 'คลังฉะเชิงเทรา', 'yes');
...
CREATE TABLE IF NOT EXISTS `warehouse_product` (
  `warehouseProductID` int(11) NOT NULL AUTO_INCREMENT,
  `warehouseID` int(11) DEFAULT NULL,
  `productID` int(11) DEFAULT NULL,
  `unitsInStock` int(11) NOT NULL,
  PRIMARY KEY (`warehouseProductID`),
  KEY `FK_9nwn0hxunrqq4vtra22hq6rrg` (`warehouseID`),
  KEY `FK_dp5pdrit1v7qoec586l5qo9sp` (`productID`)
...
INSERT INTO `warehouse_product` (`warehouseProductID`, `warehouseID`, `productID`, `unitsInStock`) VALUES
(5, 1, 7, 30),
(6, 1, 4, 40),
(7, 3, 5, 20),
(11, NULL, NULL, 100),
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `FK_ergi2uoi8h38jikomkqe5343q` FOREIGN KEY (`brandID`) REFERENCES `brand` (`brandID`),
  ADD CONSTRAINT `FK_ftjs049l02amiawgxkdyn3mct` FOREIGN KEY (`unitID`) REFERENCES `unit` (`unitID`),
  ADD CONSTRAINT `FK_kyh5g9n7oum9dfwt5eaf8b2b1` FOREIGN KEY (`catagoryID`) REFERENCES `catagory` (`catagoryID`);

--
-- Constraints for table `purchaseorder`
--
ALTER TABLE `purchaseorder`
  ADD CONSTRAINT `FK_povsc206v27p0awpd0en0xmg7` FOREIGN KEY (`supplierID`) REFERENCES `supplier` (`supplierID`);

--
-- Constraints for table `purchaseorderproduct`
--
ALTER TABLE `purchaseorderproduct`
  ADD CONSTRAINT `FK_oy5h77qvmksegi5v8sk43e716` FOREIGN KEY (`productID`) REFERENCES `product` (`productID`);

--
-- Constraints for table `recieptorder`
--
ALTER TABLE `recieptorder`
  ADD CONSTRAINT `FK_2a0skl2r1l015jsty7qglw39w` FOREIGN KEY (`supplierID`) REFERENCES `supplier` (`supplierID`);

--
-- Constraints for table `recieptorderproduct`
--
ALTER TABLE `recieptorderproduct`
  ADD CONSTRAINT `FK_aghi9709oqfrvb6pvbrw674qp` FOREIGN KEY (`productID`) REFERENCES `product` (`productID`);

--
-- Constraints for table `warehouse_product`
--
ALTER TABLE `warehouse_product`
  ADD CONSTRAINT `FK_9nwn0hxunrqq4vtra22hq6rrg` FOREIGN KEY (`warehouseID`) REFERENCES `warehouse` (`warehouseID`),
  ADD CONSTRAINT `FK_dp5pdrit1v7qoec586l5qo9sp` FOREIGN KEY (`productID`) REFERENCES `product` (`productID`);
